...
import app.athena.restapi.repositories.*;
...
public class DbSeeder implements CommandLineRunner {
    ...
    public DbSeeder (SubjectRepository subjectRepository, UserRepository userRepository, CourseRepositroy courseRepositroy){
